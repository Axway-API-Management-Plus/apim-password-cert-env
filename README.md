...
| disablehttps_portname           | Disable https listener             | Disables HTTPS Listener Interface, possible values true and false                                                                                                                                     |
| disablehttp_portname            | Disable http listener              | Disables HTTP Listener Interface, possible values true and false                                                                                                                                      |
...
- Enable Cassandra SSL
```bash
$export cassandra_disablessl=false
```
